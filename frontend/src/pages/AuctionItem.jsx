...
import { getAuctionDetail, placeBid } from "@/store/slices/auctionSlice";
...
const AuctionItem = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-10 lg:pl-[320px] flex flex-col">
        ...
        {loading ? (
          ...
          <div className="flex gap-4 flex-col lg:flex-row">
            <div className="flex-1 flex flex-col gap-3">
              <div className="flex gap-4 flex-col lg:flex-row">
                <div className="bg-white w-[100%] lg:w-40 lg:h-40 flx justify-center items-center p-5">
                  <img
