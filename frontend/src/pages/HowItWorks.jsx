...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        'Users can register as either a "Bidder" or "Auctioner." Bidders can bid on items, while Auctioneers can post items.',
    },
    {
      icon: <FaEnvelope />,
  ...
  return (
    <>
      <section className="w-full ml-0 h-fit px-5 pt-15 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <h1
          className={`text-[#d6482b] font-bold mb-2 min-[480px]: text-2xl md:text-6xl xl:text-4xl 2xl:text-5xl`}
        >
          Discover How BidSphere Operates
        </h1>
          ...
          {steps.map((element, index) => {
            return (
              ...
              >
                ...
                <h3
                  className={`text-[#D6482b] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl pl-4`}
                >
                  {element.title}
                </h3>
                </div>
