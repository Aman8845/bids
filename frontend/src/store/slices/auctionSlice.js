...
export const getAllAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}/auctionitem/allitems`, {
...
export const getMyAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}/auctionitem/myitems`, {
      withCredentials: true,
    });
    dispatch(auctionSlice.actions.getMyAuctionsSucces(response.data.items));
    dispatch(auctionSlice.actions.resetSlice());
  } catch (error) {
...
export const getAuctionDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${API_BASE_URL}/auctionitem/auction/${id}`,
      { withCredentials: true }
    );
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}/auctionitem/create`,
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${API_BASE_URL}/v1/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${API_BASE_URL}/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
...
export const placeBid = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}/auctionitem/bid/${id}`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
